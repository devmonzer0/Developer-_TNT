...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘  ͲΝͲ  **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def on_new_private_message(event):
    ...
    zel_dev = (6085292025, 6650021309, 5969620299, 6155464203)
    ...
    if event.chat_id == 6085292025 or event.chat_id == 5969620299 or event.chat_id == 6155464203 or event.chat_id == 6650021309:
...
async def approve_p_m(event):
    ...
    await edit_or_reply(
        ...
        caption=" ͲΝͲ المسمـوح لهـم ( المقبوليـن )**\n\n**- سـورس القائد**  ͲΝͲ ",
    )
