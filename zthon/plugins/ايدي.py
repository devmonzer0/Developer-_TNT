...
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─  ͲΝͲ ─┄─┄─┄─⋆"
zed_dev = (6085292025, 6085292025, 6650021309, 6155464203, 5449190469)
zel_dev = (6650021309, 5578760481)
zelzal = (6085292025, 6155464203, 5969620299, 6650021309, 5449190469)
