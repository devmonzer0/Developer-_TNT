...
zel_dev = (6085292025, 5969620299, 6155464203)
...
async def zedgban(event):  # sourcery no-metrics
    ...
    if user.id == 6085292025 or user.id == 6155464203 or user.id == 5969620299 or user.id == 6650021309:
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 6085292025 or user.id == 5969620299 or user.id == 6155464203 or user.id == 6650021309:
