...
ZelzalDV_cmd = (
    "𓆩 [ՏΌႮᎡᏟᎬ ͲΝͲ - اوامر بوت استخراج الجلسات](t.me/TNT_source) 𓆪\n\n"
    "⪼ بوت استخراج جلسات الخاص بسورس TNT \n"
    "⪼(@Sessions_TNT_bot)n"
    "⪼ ⪼ برعاية المطور منذر \n"
    "\n𓆩 [Monzer مــنــذر](t.me/p_e_y) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت TNT انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت TNT انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
