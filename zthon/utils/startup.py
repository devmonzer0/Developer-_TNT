    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/e74c8e6b6edf93ac2e73b.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس TNT الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("ՏΌႮᎡᏟᎬ ͲΝͲ", "https://t.me/TNT_source"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "TNT")
...
zthon = {"@TNT_source", "@Monzer_rashq", "@TNT_Ex_Z", "@Visa_TNT", "@TNT_CL", "@Dev_TNT"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/storage.jpg")

        _, groupid = await create_supergroup(

            "كـروب السجـل TNT", zedub, Config.TG_BOT_USERNAME, descript, photozed
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/Notifications.jpg")
