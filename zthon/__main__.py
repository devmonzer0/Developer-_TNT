...
LOGS = logging.getLogger("سورس TNT")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["TNT_source","Help_Tnt","TNT_CL","Visa_TNT","TNT_Ex_Z","Dev_TNT","Help_Leader","Monzer_rashq","leader_VIAS","P_E_Q_A"] 
